%-----------------------------------------------------------------
% The Matlab source code of the 160-bar spatial truss structure
...
xmax = 42;                % Upper bound of design variables
popsize = 30;             % Population size (20 for GO and 30 for IHGO)
dimension = 38;           % Problem dimension
MaxFEs = 15000;           % Maximum number of objective function evaluations
